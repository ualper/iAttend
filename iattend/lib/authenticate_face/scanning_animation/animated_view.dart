...
class _AnimatedViewState extends State<AnimatedView> with SingleTickerProviderStateMixin, AutomaticKeepAliveClientMixin {
  ...
  void initState() {
    ...
    opacity = Tween<double>(begin: 0.8, end: 0.0).animate(CurvedAnimation(parent: animationController, curve: Curves.easeIn));
    animation = Tween<double>(begin: 0, end: 140).animate(CurvedAnimation(parent: animationController, curve: Curves.easeInOutQuad))
      ..addListener(() {
        setState(() {});
      })
